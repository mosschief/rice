...
if [ "$RICE_THEME" = "night" ]; then
    ...
    # focused-window border: pure white (the fg off-white reads gray on dark)
    RICE_BORDER="ffffff"
else
    RICE_THEME="day"
...
export RICE_THEME RICE_BG RICE_ACCENT RICE_FG RICE_BORDER
...
export RICE_BORDER_ARGB="0xff${RICE_BORDER}"
