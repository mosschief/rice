...
-- Super+F fullscreens Firefox in Hyprland only; Firefox isn't told, so it keeps its tabs/toolbar
hl.window_rule({ match = { class = "^(firefox|zen)$" }, sync_fullscreen = false })
