#!/bin/sh
# Hyprland day theme — standalone copy of the sway theme-day.sh.
# Only the compositor block (hyprctl) differs from the sway version.
hyprctl keyword misc:background_color       'rgb(f2f1e5)'
hyprctl keyword general:col.active_border   'rgb(000000)'
hyprctl keyword general:col.inactive_border 'rgb(deddd1)'
